...
105. **COST waves construidas como BOTONES OPT-IN (2026-06-18, deployadas — gasto gateado al user)**:
    ...
    - **🎉 ROADMAP COMPLETO**: Phases 6-17 + todas las olas (safe/cost) + home "Hoy" + dialpad + _leadStore-sync → DONE y deployado. Pendientes menores opcionales (no roadmap): WhatsApp-capable Apify (COST-2b), sync reactivo multi-vista (rewrite grande, opcional), battlecards (contenido del user), compliance legal (abogado). Cache-buster `v=20260618l` (app.js), style.css `v=20260618a`.
