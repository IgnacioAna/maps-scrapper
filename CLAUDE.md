...
203. **Cache-buster actual: `app.js v=20260903a`** (reemplaza #123/#133/#158). `style.css` en `v=20260822a` (no se tocó), `wa.js` en `v=20260815c`. **Suite completa 2393/2393 (127 archivos).**
